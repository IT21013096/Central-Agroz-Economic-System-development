...
describe("Test Fertilizer Distribution", () => {
  ...
  test("renders input fields and submit button", () => {
    ...
    const farmerUsernameInput = screen.getByPlaceholderText(
      "Enter farmer username"
    );
    expect(farmerUsernameInput).toBeInTheDocument();

    const fertilizerTypeInput = screen.getByPlaceholderText(
      "Enter fetilizer type"
    );
  ...
  test("handles form submission correctly", async () => {
    ...
    expect(axios.post).toHaveBeenCalledWith(
      "https://central-agroz-economic-system.onrender.com/ao/addfertilizer",
